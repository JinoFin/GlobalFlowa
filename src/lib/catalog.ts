...
export const serviceCategories: ServiceCategory[] = [
  ...
  },
  {
    ...
    summary:
      "WEEE/ElektroG, EU battery rules and BattDG, VerpackG/LUCID, GPSR economic-operator support, document review, and authority case coordination.",
    icon: ShieldCheck,
  },
  {
    key: "warehouse",
...
const vatQuestions: ServiceQuestion[] = [
  ...
  { key: "filing_support", label: "Need ongoing VAT return coordination?", type: "yes_no", order: 6 },
...
const batteryQuestions: ServiceQuestion[] = [
  { key: "battery_category", label: "Battery category under Regulation (EU) 2023/1542, if known", type: "select", options: ["Portable battery", "Light means of transport (LMT) battery", "Starting, lighting or ignition (SLI) battery", "Industrial battery", "Electric vehicle battery", "Not sure"], order: 1 },
...
const responsiblePersonQuestions: ServiceQuestion[] = [
  ...
  { key: "applicable_product_law", label: "Product-specific EU legislation identified, if known", type: "text", order: 4 },
  { key: "doc_available", label: "Declaration of Conformity available, if applicable?", type: "yes_no", order: 5 },
  { key: "test_reports_available", label: "Test reports available?", type: "yes_no", order: 6 },
  { key: "manual_available", label: "Instructions or safety information available?", type: "yes_no", order: 7 },
  { key: "risk_assessment_available", label: "Product risk assessment available?", type: "yes_no", order: 8 },
  { key: "economic_operator_role", label: "Current EU economic-operator role, if known", type: "select", options: ["EU manufacturer", "Importer", "Authorised representative", "Fulfilment service provider", "Not established / not sure"], order: 9 },
  { key: "marketplace_link", label: "Marketplace listing link", type: "text", order: 10 },
  { key: "urgent_case", label: "Current authority or marketplace case?", type: "yes_no", order: 11 },
  { key: "case_deadline", label: "Deadline shown in the current notice", type: "date", order: 12 },
];
...
export const services: Service[] = [
  ...
  },
  {
    ...
    whoNeedsIt: "Businesses whose stock locations, transaction chain, customer type or chosen VAT scheme may create a German registration or filing need.",
  ...
  },
  {
    ...
    name: "EU Batteries Regulation / BattDG support",
    category: "compliance",
    shortDescription: "Current EU battery and German BattDG registration and producer-responsibility coordination.",
    whoNeedsIt: "Sellers placing batteries, built-in batteries, or battery-powered products on the German market.",
    requiredInformation: ["Current battery category", "Chemistry", "Weight", "Estimated yearly quantity"],
  ...
  },
  {
    ...
    name: "GPSR economic-operator / Responsible Person support",
    category: "compliance",
    shortDescription: "Product-scope, economic-operator and documentation support under GPSR and applicable product-specific rules.",
    whoNeedsIt: "Businesses placing consumer products in the EU that need product-scope, economic-operator or documentation assessment.",
    requiredInformation: ["Manufacturer details", "Product category", "Marketplace link", "Urgency and deadlines"],
    requiredDocuments: ["Product and label photos", "Instructions and risk assessment", "Technical documentation, test reports or DoC where applicable", "Current marketplace or authority notice"],
    processSteps: ["Assess product scope and roles", "Review product-specific documents", "Identify gaps", "Coordinate a legally available support path"],
  ...
  },
  {
    ...
    whoNeedsIt: "Sellers whose applicable product-specific legislation requires a Declaration of Conformity, or who received a document request that needs validation.",
  ...
  },
  {
    ...
    whoNeedsIt: "Amazon sellers with current product-document, WEEE/ElektroG, battery/BattDG, VerpackG or GPSR requests.",
...
export const knowledgeArticles: KnowledgeArticle[] = [
  ...
  {
    slug: "battg",
    title: "EU Batteries Regulation / German BattDG",
    summary: "Current EU and German producer-responsibility considerations for batteries and battery-powered products.",
    whatItIs: "Regulation (EU) 2023/1542 is the directly applicable EU framework and Germany's BattDG implements and supplements its administration; most of the former BattG was repealed in October 2025.",
  ...
  },
  {
    ...
    summary: "Consumer-product scope, economic-operator roles and product-document expectations under GPSR and product-specific law.",
    whatItIs: "GPSR provides a horizontal consumer-product safety framework. Product-specific Union harmonisation legislation may add or replace particular requirements.",
    whoNeedsIt: "Businesses placing consumer products on the EU market or responding to GPSR and product-specific document requests.",
  ...
  },
  {
    ...
    whatItIs: "German VAT registration and filing outcomes depend on facts including stock location, transaction chain, customer type, imports and available special schemes.",
    whoNeedsIt: "Businesses that need a fact-specific assessment of German transactions, stock movements or marketplace fulfilment.",
  ...
  },
  {
    ...
    whatItIs: "Formation of a GmbH or UG involves legally valid formation documents, notarial steps, commercial-register entry and related tax and operational setup.",
  ...
  },
  {
    ...
    whatItIs: "Warehouse preparation applies customer-supplied handling, packing and label instructions after product acceptance review; it is not laboratory testing or certification.",
